    ...
    const farmData =()=>{
        return(
            <ScrollView>
                ...
                renderItem={({item}) =>{ 
                return(
                    <TouchableOpacity onPress={()=>{setFarm(item.farm); setOpenFarm(false);
                    // if(plot !=='' && block !== ''){
                    //     fetchPlotNo();
                    // }
                    }}>
    ...
    const stageData =()=>{
        return(
            <ScrollView>
                ...
                renderItem={({item}) =>{ 
                return(
                    <TouchableOpacity onPress={()=>{setStage(item.stage);
                    setOpenStage(false);}}>
                    <View style={{width:'100%', borderColor:'black',height:25}}>
    ...
    const substageData =()=>{
        return(
            <ScrollView>
                ...
                renderItem={({item}) =>{ 
                return(
                    <TouchableOpacity onPress={()=>{setSubStage(item.text);
    ...
    const subfertilizerData =()=>{
        return(
            <ScrollView>
                ...
                renderItem={({item}) =>{ 
                return(
                    <TouchableOpacity onPress={()=>{setSubFertilizer(item.text);
    ...
    const subWeedicidesData =()=>{
        return(
            <ScrollView>
                ...
                renderItem={({item}) =>{ 
                return(
                    <TouchableOpacity onPress={()=>{setSubWeedicides(item.text);
    ...
    const subPesticidesData =()=>{
        return(
            <ScrollView>
                ...
                renderItem={({item}) =>{ 
                return(
                    <TouchableOpacity onPress={()=>{setSubPesticides(item.text);
    ...
    const subSowingData =()=>{
        return(
            <ScrollView>
                ...
                renderItem={({item}) =>{ 
                return(
                    <TouchableOpacity onPress={()=>{setSubSowing(item.text);
    ...
    const subIrrigationData =()=>{
        return(
            <ScrollView>
                ...
                renderItem={({item}) =>{ 
                return(
                    <TouchableOpacity onPress={()=>{setSubIrrigation(item.text);
...
useEffect(()=>{
    ...
    return(
        ...
        <Inputform2 heading="Date" value={date1} onChange={handleDate}/>
            ...
            <Inputform heading="Farm" text={farm} onPress={()=>{handleFarm()}} openDrop={openFarm} Dropdown={farmData()}/>
            </View>
            <View style={{
                width:'45%'
            }}>
